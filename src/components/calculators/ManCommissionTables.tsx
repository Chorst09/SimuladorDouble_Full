...
export interface ManCommissionData {
...
interface ManCommissionTablesProps {
  commissionData: ManCommissionData;
  onCommissionDataChange: (data: ManCommissionData) => void;
}

export const ManCommissionTables: React.FC<ManCommissionTablesProps> = ({ 
  commissionData, 
  onCommissionDataChange 
}) => {
  const [isEditing, setIsEditing] = useState(false);
  const [editableData, setEditableData] = useState<ManCommissionData>({ ...commissionData });
    ...
    <div className="space-y-6">
      <Card className="border-0 bg-gray-900 text-white">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <CardTitle className="text-lg font-medium">Tabela de Comissões - Internet MAN</CardTitle>
          {!isEditing ? (
...
export default ManCommissionTables;
