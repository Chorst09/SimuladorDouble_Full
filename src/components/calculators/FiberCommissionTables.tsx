...
export interface FiberCommissionData {
...
interface FiberCommissionTablesProps {
  commissionData: FiberCommissionData;
  onCommissionDataChange: (data: FiberCommissionData) => void;
}

export const FiberCommissionTables: React.FC<FiberCommissionTablesProps> = ({ 
  commissionData, 
  onCommissionDataChange 
}) => {
  const [isEditing, setIsEditing] = useState(false);
  const [editableData, setEditableData] = useState<FiberCommissionData>({ ...commissionData });
    ...
    <div className="space-y-6">
      <Card className="border-0 bg-gray-900 text-white">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <CardTitle className="text-lg font-medium">Tabela de Comissões - Internet Fibra</CardTitle>
          {!isEditing ? (
...
export default FiberCommissionTables;
