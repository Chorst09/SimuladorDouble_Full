...
export interface DoubleFibraRadioCommissionData {
...
interface DoubleFibraRadioCommissionTablesProps {
  commissionData: DoubleFibraRadioCommissionData;
  onCommissionDataChange: (data: DoubleFibraRadioCommissionData) => void;
}

export const DoubleFibraRadioCommissionTables: React.FC<DoubleFibraRadioCommissionTablesProps> = ({ 
  commissionData, 
  onCommissionDataChange 
}) => {
  const [isEditing, setIsEditing] = useState(false);
  const [editableData, setEditableData] = useState<DoubleFibraRadioCommissionData>({ ...commissionData });
    ...
    <div className="space-y-6">
      <Card className="border-0 bg-gray-900 text-white">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <CardTitle className="text-lg font-medium">Tabela de Comissões - Double-Fibra/Radio</CardTitle>
          {!isEditing ? (
...
export default DoubleFibraRadioCommissionTables;
